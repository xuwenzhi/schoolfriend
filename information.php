<?php
	...
	$sql_pagenow_information = "Select InfoId, InfoTitle, InfoRTime, InfoPictureAdd, InfoContent From t_information order by InfoOrder desc,InfoId desc Limit $aa, $bb ";//建立该查询
	//执行改查询
	$sqlHelper->excute_dql_asspage($sql_all_information_count, $sql_pagenow_information, $assPage);
	...
	//分配信息至模板
	$smarty->assign("GQXX" ,$assPage->pageArr); //分配供求信息
