...
$userClassid = "";
//现在修改
if($arr_get_user_classid[0]['ClassId']==""){  //如果之前没有参加任何班级  
	$userClassid .= $classid;
}else{
	$userClassid = $arr_get_user_classid[0]['ClassId'];//这是之前的ClassId
	$userClassid .= ",".$classid;
}
//将现在的ClassId 插入到表中
$sql_insert_classid = "update t_sfuser Set ClassId = '".$userClassid."' where SFUserId = $userid";
