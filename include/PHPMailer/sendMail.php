...
$MailInfor = $_POST['MailInfor']; //验证码   -  邮箱
$arr_mail_infor = explode('-',$MailInfor);
$ma = $arr_mail_infor[0]; //验证码
$to = $arr_mail_infor[1]; //邮箱地址
//本文件携带账号密码供PHP发送邮件学习使用，请勿私自更改，谢谢！--by Zjmainstay
...
$mail->Host = "smtp.sina.cn"; // 您的企业邮局域名									//smtp.qq.com
$mail->SMTPAuth = true; // 启用SMTP验证功能	
$mail->Username = "smtptester@sina.cn"; // 邮局用户名(请填写完整的email地址)		//QQ号码@qq.com
$mail->Password = "test123456"; // 邮局密码											//QQ密码
$mail->Port=25;	
$mail->From = "smtptester@sina.cn"; //邮件发送者email地址							//QQ号码@qq.com
$mail->FromName = "校友网";														//显示的名字，可以随意定义
$toAddress = $to;														//发送到的邮件地址
...
$mail->Subject = "校友网--找回密码"; //邮件标题
$mail->Body = "您本次的验证码为'$ma'   ,请在30分钟内在找回密码页填入此验证码。";
 //邮件内容
$mail->AltBody = "邮件发送失败"; //附加信息，可以省略
