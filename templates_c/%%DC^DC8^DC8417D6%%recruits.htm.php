<?php /* Smarty version 2.6.26, created on 2013-10-30 14:47:03
         compiled from recruits.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'recruits.htm', 78, false),array('modifier', 'date_format', 'recruits.htm', 79, false),array('function', 'counter', 'recruits.htm', 104, false),)), $this); ?>
<html>
<head>
            ...
            <tr>
              ...
              <?php 
	        	if(isset($_SESSION['USERID'])){
	        		echo "<td colspan='3' height='25' align='right'><a href='myrecruits.php'><font color='black' size='2'>我的招聘</font></a>　<a href='UpLoadRecruits.php'><font color='black' size='2'>发布招聘信息</font></a></td>";
	        	}else{
	        		echo "<td colspan='3' height='25' align='right'><a href='#'><font color='black' size='2'>登录可发布招聘信息</font></a></td>";
	        	}
       		  ?>
              </td>
              <td></td>
            </tr>
           <?php $_from = $this->_tpl_vars['ZPXX']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['zpxx']):
?>
            	<tr>
            		<td width="15" height="22" align="center"><img src="images/tb1.jpg" width="3" height="3"></td>
		            <td align='left'><a href='recruits_con.php?recruits_id=<?php echo $this->_tpl_vars['zpxx']['RecruitId']; ?>
' title='<?php echo $this->_tpl_vars['zpxx']['RecruitPosition']; ?>
'><?php echo ((is_array($_tmp=$this->_tpl_vars['zpxx']['RecruitTitle'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 43, "...", true) : smarty_modifier_truncate($_tmp, 43, "...", true)); ?>
</a> <img src="images/new.gif" width="15" height="6" align="absmiddle"></td>
		            <td align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['zpxx']['RecruitTime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</td>
            	</tr>
...
　				<a href="recruits.php?pageNow=1"><font color=red>首页</font></a>　
			<?php else: ?>
				<a href="recruits.php?pageNow=1">首页</a>　
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] > 10): ?>
				<a href='recruits.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-10; ?>
'><<</a>
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] != 1): ?>
				<a href='recruits.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-1; ?>
'>上一页</a>　
			<?php else: ?>
				    上一页
			<?php endif; ?>
...
?>   			<?php if ($this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage'] < $this->_tpl_vars['pageCount']): ?>
        	   	<a href='recruits.php?pageNow=<?php echo $this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage']+1; ?>
...
'>>></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['pageNow'] == $this->_tpl_vars['pageCount']): ?>
　				<a href="recruits.php?pageNow=<?php echo $this->_tpl_vars['pageCount']; ?>
