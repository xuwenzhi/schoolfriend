<?php /* Smarty version 2.6.26, created on 2013-10-26 06:47:15
         compiled from thing.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'thing.htm', 80, false),array('function', 'counter', 'thing.htm', 105, false),)), $this); ?>
      ...
      <tr>
        <td height="200" colspan="3" valign="top">
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <!-- 这里将新闻公告显示 -->
            <?php $_from = $this->_tpl_vars['XRQS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['THING']):
?>
            <tr>
              <td width="15" height="22" align="center"><img src="images/tb1.jpg" width="3" height="3"></td>
              <td align='left'><a href='thing_con.php?thing_id=<?php echo $this->_tpl_vars['THING']['ThingId']; ?>
' title='<?php echo $this->_tpl_vars['THING']['ThingTitle']; ?>
'><?php echo $this->_tpl_vars['THING']['ThingTitle']; ?>
</a> <img src="images/new.gif" width="15" height="6" align="absmiddle"></td>
              <td align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['THING']['ThingTime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</td>
            </tr>
...
　				<a href="thing.php?pageNow=1"><font color=red>首页</font></a>　
			...
			<?php endif; ?>
				...
				<a href='thing.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-10; ?>
'><<</a>
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] != 1): ?>
				<a href='thing.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-1; ?>
'>上一页</a>　
			<?php else: ?>
				    上一页
			<?php endif; ?>
...
?>   			<?php if ($this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage'] < $this->_tpl_vars['pageCount']): ?>
        	   	<a href='thing.php?pageNow=<?php echo $this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage']+1; ?>
...
'>>></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['pageNow'] == $this->_tpl_vars['pageCount']): ?>
　				<a href="thing.php?pageNow=<?php echo $this->_tpl_vars['pageCount']; ?>
