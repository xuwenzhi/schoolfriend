<?php /* Smarty version 2.6.26, created on 2013-09-16 01:19:46
         compiled from myGoodsInfor.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'myGoodsInfor.htm', 70, false),array('modifier', 'date_format', 'myGoodsInfor.htm', 71, false),array('function', 'counter', 'myGoodsInfor.htm', 98, false),)), $this); ?>
<html>
<head>
      ...
      <tr>
        <td height="200" colspan="3" valign="top">
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <?php $_from = $this->_tpl_vars['MYGQXX']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
'> [<?php echo $this->_tpl_vars['Infor']['InfoType']; ?>
]  <?php echo ((is_array($_tmp=$this->_tpl_vars['Infor']['InfoTitle'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 38, "...", true) : smarty_modifier_truncate($_tmp, 38, "...", true)); ?>
		            ...
		            <td align='right'><a href='include/addFontInforControl.php?infor_id=<?php echo $this->_tpl_vars['Infor']['InfoId']; ?>
'>删除</a></td>
            	</tr>
...
　				<a href="myGoodsInfor.php?pageNow=1"><font color=red>首页</font></a>　
			<?php else: ?>
				<a href="myGoodsInfor.php?pageNow=1">首页</a>　
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] > 10): ?>
				<a href='myGoodsInfor.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-10; ?>
'><<</a>
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] != 1): ?>
				<a href='myGoodsInfor.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-1; ?>
'>上一页</a>　
			<?php else: ?>
				    上一页
			<?php endif; ?>
...
?>   			<?php if ($this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage'] < $this->_tpl_vars['pageCount']): ?>
        	   	<a href='myGoodsInfor.php?pageNow=<?php echo $this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage']+1; ?>
...
'>>></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['pageNow'] == $this->_tpl_vars['pageCount']): ?>
　				<a href="myGoodsInfor.php?pageNow=<?php echo $this->_tpl_vars['pageCount']; ?>
