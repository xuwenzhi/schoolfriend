<?php /* Smarty version 2.6.26, created on 2013-10-30 14:47:02
         compiled from applys.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'applys.htm', 72, false),array('modifier', 'date_format', 'applys.htm', 73, false),array('function', 'counter', 'applys.htm', 98, false),)), $this); ?>
<html>
<head>
...
smarty_core_smarty_include_php(array('smarty_file' => "hotnews.php", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
    ...
    <td valign="top" class="border">
      ...
      <tr>
        ...
        <td width="82%" align="right" background="images/bg1.jpg" class="zi-hui12"><img src="images/tb3.gif" width="9" height="9"> 首页 > 求职信息&nbsp;<?php echo $this->_tpl_vars['num']; ?>
</td>
      </tr>
       <tr>
      	<?php 
...
　				<a href="applys.php?pageNow=1"><font color=red>首页</font></a>　
			...
			<?php endif; ?>
				...
				<a href='applys.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-10; ?>
'><<</a>
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] != 1): ?>
				<a href='applys.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-1; ?>
'>上一页</a>　
			<?php else: ?>
				    上一页
			<?php endif; ?>
...
?>   			<?php if ($this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage'] < $this->_tpl_vars['pageCount']): ?>
        	   	<a href='applys.php?pageNow=<?php echo $this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage']+1; ?>
...
'>>></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['pageNow'] == $this->_tpl_vars['pageCount']): ?>
　				<a href="applys.php?pageNow=<?php echo $this->_tpl_vars['pageCount']; ?>
