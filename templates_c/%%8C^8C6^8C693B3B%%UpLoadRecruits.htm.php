<?php /* Smarty version 2.6.26, created on 2013-09-28 04:26:11
         compiled from UpLoadRecruits.htm */ ?>
<html>
<head>
...
width="9" height="9" align="absmiddle"> 首页 > 今昔风采&nbsp;</td>
      ...
      <tr>
        ...
        <form action="include/disposeUploadRec.php" method='post' >
				...
				<?php $_from = $this->_tpl_vars['TRADETYPE']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tradetype']):
?>
					<option value="<?php echo $this->_tpl_vars['tradetype']['TradeId']; ?>
"><?php echo $this->_tpl_vars['tradetype']['TradeName']; ?>
</option>
             ...
             <tr>
                ...
                <select name="Location">
               		<?php $_from = $this->_tpl_vars['CITYTYPE']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['citytype']):
?>
                	<option value="<?php echo $this->_tpl_vars['citytype']['CityId']; ?>
"><?php echo $this->_tpl_vars['citytype']['CityName']; ?>
</option>
                    <?php endforeach; endif; unset($_from); ?>
                </select>
                </td>
