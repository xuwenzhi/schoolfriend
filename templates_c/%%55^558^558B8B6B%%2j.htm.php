<?php /* Smarty version 2.6.26, created on 2013-07-31 03:13:08
         compiled from 2j.htm */ ?>
  ...
  <tr>
    ...
    <td valign="top">
      <table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="325" height="238" valign="top" class="border"><table width="100%" border="0" cellspacing="0" 

cellpadding="0">
          <tr>
            <td width="97" height="29" align="center" background="images/1_14.jpg" class="zi-bai14b">个人中心</td>
            <td width="218" align="right" background="images/1_15.jpg"><img src="images/tc.gif" 

align="absmiddle">&nbsp;</td>
          </tr>
          <tr>
            <td height="188" colspan="2" valign="top"><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "myMenu.htm", 'smarty_include_vars' => array()));
