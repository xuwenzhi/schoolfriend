<?php /* Smarty version 2.6.26, created on 2013-10-19 11:23:50
         compiled from uploadPic.htm */ ?>
<html>
<head>
...
width="9" height="9" align="absmiddle"> 首页 > 今昔风采&nbsp;</td>
      ...
      <tr>
        ...
        <form action="include/disposeUploadPic.php?type=1&do=update"  enctype="multipart/form-data" method='post' id='uploadForm'>
				...
				<?php $_from = $this->_tpl_vars['MIENSTYPE']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['mienstype']):
?>
					<option value='<?php echo $this->_tpl_vars['mienstype']['CodeId']; ?>
'><?php echo $this->_tpl_vars['mienstype']['CodeName']; ?>
</option>
