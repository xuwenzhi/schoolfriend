<?php
/* Smarty version 3.1.33, created on 2020-05-19 07:44:04
  from '/data/wwwroot/school.xuwenzhi.com/templates/thing.htm' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ec31dc4af5d51_49301270',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1957e3e99d6069f96bc47019af39e1f5dd6b2808' => 
    array (
      0 => '/data/wwwroot/school.xuwenzhi.com/templates/thing.htm',
      1 => 1589845131,
      2 => 'file',
    ),
  ),
...
function content_5ec31dc4af5d51_49301270 (Smarty_Internal_Template $_smarty_tpl) {
      ...
      <tr>
        <td height="200" colspan="3" valign="top">
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <?php 
	        	if(isset($_SESSION['USERID'])){
	        		echo "<td colspan='3' height='25' align='right'><a href='addFontThing.php'><font color='black' size='2'>添加昔日趣事</font></a></td>";
	        	}else{
	        		echo "<td colspan='3' height='25' align='right'><a href='#'><font color='black' size='2'>登录可添加昔日趣事</font></a></td>";
	        	}
       		 ?>
              </td>
              <td></td>
            ...
            <!-- 这里将新闻公告显示 -->
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['XRQS']->value, 'THING');
if ($_from !== null) {
...
?>
            <tr>
              ...
              <td align='left'><a href='thing_con.php?thing_id=<?php echo $_smarty_tpl->tpl_vars['THING']->value['ThingId'];?>
' title='<?php echo $_smarty_tpl->tpl_vars['THING']->value['ThingTitle'];?>
'><?php echo $_smarty_tpl->tpl_vars['THING']->value['ThingTitle'];?>
</a> <img src="images/new.gif" width="15" height="6" align="absmiddle"></td>
              <td align='right'><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['THING']->value['ThingTime'],"%Y-%m-%d");?>
</td>
            </tr>
            <?php
}
...
　				<a href="thing.php?pageNow=1"><font color=red>首页</font></a>　
			<?php } else { ?>
				<a href="thing.php?pageNow=1">首页</a>　
			<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['pageNow']->value > 10) {?>
				<a href='thing.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageNow']->value-10;?>
'><<</a>
			<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['pageNow']->value != 1) {?>
				<a href='thing.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageNow']->value-1;?>
'>上一页</a>　
			<?php } else { ?>
				    上一页
			<?php }?>
...
?>   			<?php if ($_smarty_tpl->tpl_vars['pageStart']->value+$_smarty_tpl->tpl_vars['mypage']->value < $_smarty_tpl->tpl_vars['pageCount']->value) {?>
        	   	<a href='thing.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageStart']->value+$_smarty_tpl->tpl_vars['mypage']->value+1;?>
...
'>>></a>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['pageNow']->value == $_smarty_tpl->tpl_vars['pageCount']->value) {?>
　				<a href="thing.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageCount']->value;?>
