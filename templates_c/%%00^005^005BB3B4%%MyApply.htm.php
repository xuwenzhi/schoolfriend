<?php /* Smarty version 2.6.26, created on 2013-09-16 04:23:20
         compiled from MyApply.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'MyApply.htm', 72, false),array('modifier', 'date_format', 'MyApply.htm', 73, false),array('function', 'counter', 'MyApply.htm', 98, false),)), $this); ?>
<html>
<head>
      ...
      <tr>
        <td height="200" colspan="3" valign="top">
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
           ...
           <?php $_from = $this->_tpl_vars['QZXX']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['qzxx']):
?>
            	<tr>
            		<td width="15" height="22" align="center"><img src="images/tb1.jpg" width="3" height="3"></td>
		            <td align='left'><a href='apply_con.php?apply_id=<?php echo $this->_tpl_vars['qzxx']['ApplyId']; ?>
' title='<?php echo $this->_tpl_vars['qzxx']['ApplyUnit']; ?>
'><?php echo ((is_array($_tmp=$this->_tpl_vars['qzxx']['ApplyUnit'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 43, "...", true) : smarty_modifier_truncate($_tmp, 43, "...", true)); ?>
</a> <img src="images/new.gif" width="15" height="6" align="absmiddle"></td>
		            <td align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['qzxx']['ApplyTime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
&nbsp;<a href="./include/disposeSetApply.php?apply_id=<?php echo $this->_tpl_vars['qzxx']['ApplyId']; ?>
&do=delete">删除</a>&nbsp;</td>
            	</tr>
...
　				<a href="MyApply.php?pageNow=1"><font color=red>首页</font></a>　
			<?php else: ?>
				<a href="MyApply.php?pageNow=1">首页</a>　
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] > 10): ?>
				<a href='MyApply.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-10; ?>
'><<</a>
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] != 1): ?>
				<a href='MyApply.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-1; ?>
'>上一页</a>　
			<?php else: ?>
				    上一页
			<?php endif; ?>
...
?>   			<?php if ($this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage'] < $this->_tpl_vars['pageCount']): ?>
        	   	<a href='MyApply.php?pageNow=<?php echo $this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage']+1; ?>
...
'>>></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['pageNow'] == $this->_tpl_vars['pageCount']): ?>
　				<a href="MyApply.php?pageNow=<?php echo $this->_tpl_vars['pageCount']; ?>
