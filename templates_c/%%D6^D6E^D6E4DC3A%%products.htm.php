<?php /* Smarty version 2.6.26, created on 2013-10-30 14:46:58
         compiled from products.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'products.htm', 70, false),array('modifier', 'date_format', 'products.htm', 71, false),array('function', 'counter', 'products.htm', 96, false),)), $this); ?>
<html>
<head>
...
?>
            	<tr>
		            ...
		            <td align='left'><a href='product_con.php?product_id=<?php echo $this->_tpl_vars['product']['ProductId']; ?>
' title='<?php echo $this->_tpl_vars['product']['ProductName']; ?>
'><?php echo ((is_array($_tmp=$this->_tpl_vars['product']['ProductName'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 43, "...", true) : smarty_modifier_truncate($_tmp, 43, "...", true)); ?>
</a> <img src="images/new.gif" width="15" height="6" align="absmiddle"></td>
		            <td align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['product']['ProductRTime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</td>
            	</tr>
...
　				<a href="products.php?pageNow=1"><font color=red>首页</font></a>　
			...
			<?php endif; ?>
				...
				<a href='products.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-10; ?>
'><<</a>
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] != 1): ?>
				<a href='products.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-1; ?>
'>上一页</a>　
			<?php else: ?>
				    上一页
			<?php endif; ?>
...
?>   			<?php if ($this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage'] < $this->_tpl_vars['pageCount']): ?>
        	   	<a href='products.php?pageNow=<?php echo $this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage']+1; ?>
...
'>>></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['pageNow'] == $this->_tpl_vars['pageCount']): ?>
　				<a href="products.php?pageNow=<?php echo $this->_tpl_vars['pageCount']; ?>
