<?php /* Smarty version 2.6.26, created on 2013-09-28 04:26:02
         compiled from myrecruits.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'myrecruits.htm', 72, false),array('modifier', 'date_format', 'myrecruits.htm', 73, false),array('function', 'counter', 'myrecruits.htm', 98, false),)), $this); ?>
<html>
<head>
...
' title='<?php echo $this->_tpl_vars['zpxx']['RecruitTitle']; ?>
...
&nbsp;<a href="./bkadmin/include/disposeRecruits.php?recruits_id=<?php echo $this->_tpl_vars['zpxx']['RecruitId']; ?>
&do=delete">删除</a>&nbsp;</td>
            	</tr>
...
　				<a href="myrecruits.php?pageNow=1"><font color=red>首页</font></a>　
			...
			<?php endif; ?>
				...
				<a href='myrecruits.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-10; ?>
'><<</a>
			<?php endif; ?>
						<?php if ($this->_tpl_vars['pageNow'] != 1): ?>
				<a href='myrecruits.php?pageNow=<?php echo $this->_tpl_vars['pageNow']-1; ?>
'>上一页</a>　
			<?php else: ?>
				    上一页
			<?php endif; ?>
...
?>   			<?php if ($this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage'] < $this->_tpl_vars['pageCount']): ?>
        	   	<a href='myrecruits.php?pageNow=<?php echo $this->_tpl_vars['pageStart']+$this->_tpl_vars['mypage']+1; ?>
...
'>>></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['pageNow'] == $this->_tpl_vars['pageCount']): ?>
　				<a href="myrecruits.php?pageNow=<?php echo $this->_tpl_vars['pageCount']; ?>
