<?php
/* Smarty version 3.1.33, created on 2020-05-19 07:41:57
  from '/data/wwwroot/school.xuwenzhi.com/templates/informations.htm' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ec31d452fdb31_69515279',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b238e8b6cf3abd1a07139326948a73295a9b786b' => 
    array (
      0 => '/data/wwwroot/school.xuwenzhi.com/templates/informations.htm',
      1 => 1589845197,
      2 => 'file',
    ),
  ),
...
function content_5ec31d452fdb31_69515279 (Smarty_Internal_Template $_smarty_tpl) {
      ...
      <tr>
        <td height="200" colspan="3" valign="top">
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['GQXX']->value, 'Infor');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['Infor']->value) {
?>
            	<tr>
            		<td width="15" height="22" align="center"><img src="images/tb1.jpg" width="3" height="3"></td>
		            <td align='left'><a href='information_con.php?infor_id=<?php echo $_smarty_tpl->tpl_vars['Infor']->value['InfoId'];?>
' title='<?php echo $_smarty_tpl->tpl_vars['Infor']->value['InfoTitle'];?>
'> [<?php echo $_smarty_tpl->tpl_vars['Infor']->value['InfoType'];?>
]  <?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['Infor']->value['InfoTitle'],43,"...",true);?>
</a> <img src="images/new.gif" width="15" height="6" align="absmiddle"></td>
		            <td align='right'><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['Infor']->value['InfoRTime'],"%Y-%m-%d");?>
</td>
            	</tr>
            <?php
}
...
　				<a href="informations.php?pageNow=1"><font color=red>首页</font></a>　
			...
			<?php if ($_smarty_tpl->tpl_vars['pageNow']->value > 10) {?>
				<a href='informations.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageNow']->value-10;?>
'><<</a>
			<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['pageNow']->value != 1) {?>
				<a href='informations.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageNow']->value-1;?>
'>上一页</a>　
			<?php } else { ?>
				    上一页
			<?php }?>
...
?>   			<?php if ($_smarty_tpl->tpl_vars['pageStart']->value+$_smarty_tpl->tpl_vars['mypage']->value < $_smarty_tpl->tpl_vars['pageCount']->value) {?>
        	   	<a href='informations.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageStart']->value+$_smarty_tpl->tpl_vars['mypage']->value+1;?>
...
?>
						<?php if ($_smarty_tpl->tpl_vars['pageNow']->value+1 < $_smarty_tpl->tpl_vars['pageCount']->value) {?>
			　      <a href='informations.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageNow']->value+1;?>
'>下一页</a>
			<?php } else { ?>
				下一页
...
　				<a href="informations.php?pageNow=<?php echo $_smarty_tpl->tpl_vars['pageCount']->value;?>
